...
public class Rectangle extends SurfaceShape {
	...
	public Rectangle clone() {
		...
		mapProps(newRectangle);
		return newRectangle;
	}

	public void mapProps(Rectangle destination) {
		destination.setUpperLeftPoint(this.getUpperLeftPoint().clone());
		destination.setHeight(this.getHeight());
		destination.setWidth(this.getWidth());
